...
<body>
    <div class="sidebar">
        ...
        <nav>
            <ul>
                ...
                <a href="../competences/ajouter.php" class="active"><img src="../img/competence.png" alt=""> <span>Compétences</span></a>
    ...
    <div class = "main-content">
        ...
        <a href="../competences/competence.php" class="fi">Ajouter une compétence</a>
        <hr>
        ...
        <?php
            ...
            $sql = "SELECT type, niveau FROM competences ORDER BY id DESC";
